/**
 * Function printf (based on C printf funtion)
 *
 * @param  [String] string with format placeholders
 * @param  [Mixed]  any number of variables to be placed to placeholders
 ...
 *        for anything.
 */
window.printf = function(fstring /* other arguments are accessed via arguments property */){
